...
metadata:
  hermes:
    ...
    triggers: [computer use, desktop automation, drive desktop, click type, gui automation, screen control, background automation, cursor control, desktop click, screenshot, cua driver]
    category: desktop
    related_skills: [hermes-browser-internals]
---
