...
metadata:
  hermes:
    tags: [minecraft, gaming, server, neoforge, dev-lead, modpack]
    triggers: [minecraft-server, modded-minecraft, dev-lead-server, neoforge, curseforge-modpack, modrinth-modpack]
    related_skills: []
---
...
ls server/
```
Look for: `startserver.sh`, installer jar (neoforge/dev-lead), `user_jvm_args.txt`, `mods/` folder.
...
# java -jar dev-lead-*-installer.jar --installServer
```
