...
metadata:
  hermes:
    tags: [fal-ai, genmedia, cli, endpoint-runner, model-catalog]
    triggers: [genmedia, fal cli, search models, run a model, fetch schema, check pricing, upload to fal, queue async job, track request, genmedia init, fal endpoint]
    related_skills: [fal-models-catalog, fal-recipes, model-routing, fal-workflow]
---
