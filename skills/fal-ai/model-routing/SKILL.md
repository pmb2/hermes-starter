...
metadata:
  hermes:
    tags: [fal-ai, model-routing, endpoint-defaults, domain-skills]
    triggers: [which endpoint, endpoint default, model route, default model for, routing decision, what model to use]
    related_skills: [genmedia, fal-models-catalog, fal-recipes, fal-ai-integration]
---
