...
metadata:
  hermes:
    tags: [fal-ai, recipes, pipelines, content-production, cinematography, character-design]
    triggers: [make a commercial, ad creative, product photography, cinematic shot, film look, character design, consistent character, storyboard, multi-shot, talking head, lip sync, virtual try-on, image restoration, old photo restore, product shot]
    related_skills: [genmedia, fal-models-catalog, model-routing, fal-workflow]
---
