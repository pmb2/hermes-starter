...
metadata:
  hermes:
    tags: [fal-ai, models, catalog, endpoints, modalities]
    triggers: [which model for, best endpoint, what should i use for, fal-ai model, endpoint id, modality reference, model catalog]
    related_skills: [model-routing, genmedia, fal-recipes]
---
