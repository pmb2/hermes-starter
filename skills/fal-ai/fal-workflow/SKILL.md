...
metadata:
  hermes:
    tags: [fal-ai, workflow, pipeline, media-generation, video, image]
    triggers: [create workflow, design pipeline, chain models, image to video, fan-out generation, frame bridging, narrated video, dataset generation, multi-step pipeline, fal workflow]
    related_skills: [genmedia, fal-recipes, fal-models-catalog, model-routing]
---
