...
metadata:
  hermes:
    ...
    triggers: [ideation, brainstorming, idea-generation, project-ideas, creative-constraints, inspiration]
    category: creative
    requires_toolsets: []
    related_skills: [songwriting-and-ai-music, design-md, sketch, architecture-diagram]
---
# Creative Ideation
