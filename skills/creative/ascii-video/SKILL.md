...
metadata:
  hermes:
    tags: [ascii-art, video-conversion, terminal-art, animation, creative-coding]
    triggers: [ascii-video, text-art-video, terminal-style-video, character-art-animation, retro-text-visualization, audio-visualizer-ascii, matrix-effects]
    related_skills: [p5js, sketch, pixel-art]
---
