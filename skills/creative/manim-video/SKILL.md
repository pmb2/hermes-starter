...
metadata:
  hermes:
    tags: [manim, animation, math-video, 3blue1brown, educational, visualization, explainer]
    triggers: [manim, math-animation, algorithm-visualization, educational-video, explainer-animation, 3blue1brown]
    related_skills: [p5js, excalidraw, architecture-diagram]
---
