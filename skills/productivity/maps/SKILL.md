...
metadata:
  hermes:
    ...
    triggers: [maps, geocoding, osm, openstreetmap, navigation, route-planning, poi-search]
    category: productivity
    requires_toolsets: [terminal]
    supersedes: [find-nearby]
    related_skills: [local-supabase]
---
...
## Geospatial Tracking Extension

The maps skill is the foundation for a larger geospatial tracking system: location
checkpoints ("I parked the car here"), path/waypoint logging (bike rides, walks),
accumulated distance, and return routing. See `references/geospatial-tracking.md`
for the full vision, tool designs, build blocks, and implementation phases.
